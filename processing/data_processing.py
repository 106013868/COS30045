...
# region groupings used for filtering in the visualisation
REGIONS = {
    "Western Europe": ["AUT", "BEL", "CHE", "DEU", "DNK", "ESP", "FIN", "FRA", "GBR",
                       "GRC", "IRL", "ISL", "ITA", "LUX", "NLD", "NOR", "PRT", "SWE"],
    "Central and Eastern Europe": ["BGR", "CZE", "EST", "HRV", "HUN", "LTU", "LVA",
                                   "POL", "ROU", "SVK", "SVN", "UKR"],
    "Americas": ["ARG", "BRA", "CAN", "CHL", "COL", "CRI", "MEX", "PER", "USA"],
    "Asia-Pacific": ["AUS", "CHN", "IDN", "IND", "JPN", "KOR", "NZL", "THA"],
    "Middle East and Africa": ["ISR", "TUR", "ZAF"]
}
...
merged["region"] = merged["code"].map(region_lookup)

# any country missing from REGIONS would get a blank region
missing = merged[merged["region"].isna()]["code"].unique()

merged = merged[["country", "code", "region", "year", "spending", "life_expectancy"]]
